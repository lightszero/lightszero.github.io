...
namespace lighttool
{
    ...
    export class spriteCanvas
    {
        ...
        drawTextureCustom(texture: spriteTexture, _mat: spriteMat, rect: spriteRect, uvrect: spriteRect = spriteRect.one, color: spriteColor = spriteColor.white, color2: spriteColor = spriteColor.white)
        {
        ...
        drawSpriteCustom(atlas: string, sprite: string, _mat: spriteMat, rect: spriteRect, color: spriteColor = spriteColor.white, color2: spriteColor = spriteColor.white)
        {
            let a = atlasMgr.Instance().load(this.webgl, atlas);
            if (a == null) return;
            var r = a.sprites[sprite];
        ...
        drawSprite9(atlas: string, sprite: string, rect: spriteRect, border: spriteBorder, color: spriteColor = spriteColor.white)
        {
            let a = atlasMgr.Instance().load(this.webgl, atlas);
            if (a == null) return;
        ...
        drawSprite9Custom(atlas: string, sprite: string, _mat: spriteMat, rect: spriteRect, border: spriteBorder, color: spriteColor = spriteColor.white, color2: spriteColor = spriteColor.white)
        {
            let a = atlasMgr.Instance().load(this.webgl, atlas);
            if (a == null) return;
            var _r = a.sprites[sprite];
